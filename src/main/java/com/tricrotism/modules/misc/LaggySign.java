 ...
 */
public final class LaggySign extends Module {

    public static final LaggySign instance = new LaggySign();

    private final Settings.Int length =
        integer("Length", "length", "Lag characters per sign line", 90, 1, 1000);
    ...
    private LaggySign() {
        super("laggysign", "Laggy Sign", "Fill signs with lag characters and send them on open.", Category.WORLD);
    }

    /**
     * Four lines of random lag characters, each {@link #length.get()} code points long.
     */
    ...
    private String randomLine() {
        StringBuilder sb = new StringBuilder(length.get());
