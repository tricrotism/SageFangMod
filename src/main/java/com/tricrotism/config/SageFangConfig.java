...
public final class SageFangConfig {
    ...
    private static final String MENU_MISC         = "menu.misc.enabled";
    ...
    public static boolean isMiscMenuEnabled()                 { return getBool(MENU_MISC, true); }
    public static void setMiscMenuEnabled(boolean v)          { setBool(MENU_MISC, v); }
